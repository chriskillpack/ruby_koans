...
EOS
    ...
    # NOTE: the one-char difference in length due to the here document behavior starting on the next line.
    # The flexible quote variation starts immediately, and so includes the CR.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # A: Yes, expected 'a'. Conclusion: strings can't be treated as Array's.
    # To recover the actual character: string[1].chr
  end
