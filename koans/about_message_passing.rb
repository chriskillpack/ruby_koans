...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # A: To call out the use of message passing.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # A: Allows you to generate Ghost Methods in which you can place
    # a lot of common code: http://rubylearning.com/blog/2010/10/07/do-you-know-rubys-chainsaw-method/
    #
    # NOTE:
    #
